...
const TeacherDashboard = () => {
  ...
  const sections = [
    ...
    { id: "calendar", label: "Class Schedule", icon: Calendar },
  ...
  const renderSection = () => {
    switch (activeSection) {
      ...
      case "calendar": return <ScheduleSection />;
...
const CoursesSection = () => (
  <div>
    ...
    <p className="text-gray-600">Manage and review your course materials.</p>
  </div>
);

const ScheduleSection = () => (
  <div>
    <h3 className="text-2xl font-semibold text-indigo-800 mb-4">Class Schedule</h3>
    <p className="text-gray-600">View and organize your teaching schedule.</p>
  </div>
);
...
const AnnouncementsSection = () => (
  <div>
    ...
    <p className="text-gray-600">Publish important updates for your students.</p>
  </div>
);

const ResourcesSection = () => (
  <div>
    <h3 className="text-2xl font-semibold text-indigo-800 mb-4">Resources</h3>
    <p className="text-gray-600">Upload or link to resources relevant to your subjects.</p>
  </div>
);
